        ...
        for faulty in faulty_sc:
            ...
            for capability in capabilities_lost:
                if capability == "attitude_control":
                    orphaned_tasks.extend(["attitude_stabilization", "pointing_control"])
                elif capability == "sensing":
                    orphaned_tasks.extend(["target_observation", "data_collection"])
                elif capability == "communication":
                    orphaned_tasks.extend(["data_relay", "ground_link"])
