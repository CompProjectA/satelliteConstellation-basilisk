#!/usr/bin/env python
"""
Improved spacecraft_fault_gui.py with modern, styled Tkinter UI.
"""
...
from spacecraft_fault_cli import SimulationConfig, TargetDefinition, run_custom_simulation
...
class FaultSimulationGUI:
    ...
    def run_simulation(self):
        try:
            ...
            self.status_label.config(text=f"Completed - {output_dir}")
